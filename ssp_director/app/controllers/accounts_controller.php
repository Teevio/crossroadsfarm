	...
	function info() {
		...
		$reports = array(
				array(
					...
					'status' => 'yes',
					'note' => sprintf(__('Activated. Key: %s', true), '<code>' . $account['Account']['activation_key'] . '</code>'),
					'button' => array('id' => '', 'label' => __('Edit key', true), 'js' => "location.href='" . DIR_HOST . "/index.php?/accounts/activate/edit'")
					),
